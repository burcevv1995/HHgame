Shader "Voxeland/Grass" 
{
	Properties 
	{
		...
		_AnimState ("Animation State", Range(0,6.283185307179586476925286766559)) = 0
	...
	SubShader 
	{
		...
		{
			//float shiftedState = v.color.g + _AnimState;
			...
			float linearState = cos(_AnimState + v.color.g*6.283185307179586476925286766559);
